import hsl from "./hsl";
console.log(hsl("steelblue", "brown")(0));
...
console.log("interpolateHsl(a, b) converts a and b to HSL colors");// function(test) {
console.log(interpolate.interpolateHsl("steelblue", "brown")(0)); console.log(color.rgb("steelblue") + "");
