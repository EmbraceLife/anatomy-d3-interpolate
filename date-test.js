// --------------------------
// use date() directly from ./date.js file

import date from "./date";
console.log(date(new Date(2000, 0, 1), new Date(2000, 0, 2))(1));
...
console.log("interpolateDate(a, b) interpolates between two dates a and b");// function(test) {
