...
console.log("interpolateCubehelixLong(a, b) converts a and b to Cubehelix colors");// function(test) {

// both hue() and color() share similar args, that's why cubehelixLong has similar args as cubehelix()
console.log(interpolate.interpolateCubehelixLong("steelblue", "brown")(0)); console.log(color.rgb("steelblue") + "");
 

// -------------------------------
console.log(interpolate.interpolateCubehelixLong("steelblue", color.hcl("brown"))(0.1)); 
console.log(color.rgb("brown") + "");

console.log(interpolate.interpolateCubehelixLong("steelblue", color.rgb("brown"))(0.1));
console.log(color.rgb("brown") + "");
