...
console.log("interpolateString(a, b) interpolates matching numbers in a and b");// function(test) {
...
console.log("interpolateString(a, b) coerces a and b to strings");// function(test) {
  console.log(interpolate.interpolateString({toString: function() { return "2px"; }}, {toString: function() { return "12px"; }})(0.25));// "4.5px");


console.log("interpolateString(a, b) preserves non-numbers in string b");// function(test) {
...
// console.log("interpolateString(a, b) preserves non-matching numbers in string b", function(test) {
...
// });
//
// console.log("interpolateString(a, b) preserves equal-value numbers in both strings", function(test) {
//   console.log(interpolate.interpolateString(" 10/20 100 20", "50/10 100, 20 ")(0.2), "18/18 100, 20 ");
//   console.log(interpolate.interpolateString(" 10/20 100 20", "50/10 100, 20 ")(0.4), "26/16 100, 20 ");
//   test.end();
// });
//
// console.log("interpolateString(a, b) interpolates decimal notation correctly", function(test) {
//   console.log(interpolate.interpolateString("1.", "2.")(0.5), "1.5");
//   test.end();
// });
//
// console.log("interpolateString(a, b) interpolates exponent notation correctly", function(test) {
...
// });
//
// console.log("interpolateString(a, b) with no numbers, returns the target string", function(test) {
...
// });
//
// console.log("interpolateString(a, b) with two numerically-equivalent numbers, returns the default format", function(test) {
//   console.log(interpolate.interpolateString("top: 1000px;", "top: 1e3px;")(0.5), "top: 1000px;");
//   console.log(interpolate.interpolateString("top: 1e3px;", "top: 1000px;")(0.5), "top: 1000px;");
//   test.end();
// });
