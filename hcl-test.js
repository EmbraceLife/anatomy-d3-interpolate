...
console.log("interpolateHcl(a, b) converts a and b to HCL colors");// function(test) {

console.log(interpolate.interpolateHcl("steelblue", "brown")(0)); console.log(color.rgb("steelblue") + "");
