// ### check inner values with console.log()

import number from "./3number";
...
var a = " 10/20 30", b = " 50/10 100 ", t = 0.2;
...
console.log("what inside `s` array after while loop: "+s);
 ...
 console.log("what inside `s` array: "+s);
