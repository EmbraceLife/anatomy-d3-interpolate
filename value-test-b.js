...
},{"./value":13}],2:[function(require,module,exports){
"use strict";
...
},{"./basis":2}],4:[function(require,module,exports){
"use strict";
...
},{"./constant":5}],5:[function(require,module,exports){
"use strict";
...
},{"./value":13}],10:[function(require,module,exports){
"use strict";
...
},{"./basis":2,"./basisClosed":3,"./color":4,"d3-color":7}],11:[function(require,module,exports){
"use strict";
...
},{"./number":8}],12:[function(require,module,exports){
"use strict";
...
var interpolateValue = function interpolateValue(a, b) {
  ...
  return b == null || t === "boolean" ? (0, _constant2.default)(b) : (t === "number" ?
  // (a,b) is 2 function args
  _number2.default : t === "string" ? (c = (0, _d3Color.color)(b)) ? (b = c, _rgb2.default) : _string2.default : b instanceof _d3Color.color ? _rgb2.default : b instanceof Date ? _date2.default : Array.isArray(b) ? _array2.default : isNaN(b) ? _object2.default : _number2.default)(a, b);
};

console.log(interpolateValue("foo", "bar")(0.5));

/*
var color = require("d3"),
    interpolate = require("d3");

console.log("\n interpolate(a, b) interpolates strings if b is a string and not a color");

console.log(interpolate.interpolate("foo", "bar")(0.5));// "bar");
...
},{"./array":1,"./constant":5,"./date":6,"./number":8,"./object":9,"./rgb":10,"./string":11,"d3-color":7}],13:[function(require,module,exports){
"use strict";
...
},{"./array":1,"./constant":5,"./date":6,"./number":8,"./object":9,"./rgb":10,"./string":11,"d3-color":7}]},{},[12]);
