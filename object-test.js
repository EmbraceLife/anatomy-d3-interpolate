...
console.log("interpolateObject(a, b) interpolates defined properties in a and b");//, function(test) {

console.log(interpolate.interpolateObject({a: 2, b: 12}, {a: 4, b: 24})(0.5));// {a: 3, b: 18});
